...
VALUES
    ('9780345339706', 'J.R.R. Tolkien', 'Fantasy', 'Il Signore degli Anelli è un epico racconto ambientato in un mondo fantastico chiamato la Terra di Mezzo. La trama ruota attorno all\'anello del potere, un potente artefatto che, per caso, finisce nelle mani di un hobbit di nome Bilbo Baggins.', 'Il Signore degli Anelli'),
...
-- QUERY PRONTA PER VEDERE QUALE LIBRO E' ASSOCIATO AD UN UTENTE
SELECT ub.user_id, u.username, ub.book_id, b.title 
FROM user u
